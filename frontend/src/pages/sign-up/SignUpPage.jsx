...
const SignUpPage = () => {
  return (
    ...
    <div className='p-6 spacey-y-4 md:space-y-6 sm:p-8'>
					<h1 className='text-xl font-bold md:text-2xl text-center cursor-pointer'>Create Account</h1>
          <button
						type='button'
          ...
          <p className='text-sm font-light text-gray-500'>
						...
						<Link to='/login' className='font-medium text-primary-600 hover:underline text-blue-600 align-center'>
							Login
						</Link>
					</p>
    </div>
